...
class Encoder(nn.Module):
    def __init__(self):
        super().__init__()
        # self.c0 = nn.Conv2d(2, 64, kernel_size=4, stride=2)
        ...
        self.l1 = nn.Linear(512*15*15, 64)
...
class LocalDiscriminator(nn.Module):
    def __init__(self):
        super().__init__()
        self.c0 = nn.Conv2d(24, 512, kernel_size=1)
...
class GlobalDiscriminator(nn.Module):
    def __init__(self):
        ...
        self.l0 = nn.Linear(32 * 122 * 122 + 64, 512)
